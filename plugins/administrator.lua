local function set_bot_photo(msg, success, result)
    ...
    if success then
        ...
        send_large_msg(receiver, langs.botPicChanged, ok_cb, false)
        redis:del("bot:photo")
    else
    ...
    if is_admin1(msg) then
        ...
        if is_sudo(msg) then
            ...
            if matches[1]:lower() == "addcontact" or matches[1]:lower() == "sasha aggiungi contatto" and matches[2] then
                ...
                return langs.user .. phone .. langs.addedToContacts
            end
