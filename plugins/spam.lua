    ...
    if is_owner(msg) then
        ...
        elseif matches[1]:lower() == 'spam' or matches[1]:lower() == 'sasha spamma' or matches[1]:lower() == 'spamma' then
            ...
            if text then
                ...
                return langs[msg.lang].msgNotSet
            end
        end
    else
        return langs[msg.lang].require_owner
