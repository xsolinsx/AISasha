...
return {
    ...
    usage =
    {
        ...
        "[#]|[sasha] info [<id>|<username>|<reply>|from]: Sasha manda le info dell'utente e della chat o di se stessa. Se è specificato uno dei parametri manda le informazioni richieste.",
