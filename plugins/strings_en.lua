...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('ingroup:31', '#kill group|realm: Sasha kicks every user in group|realm and removes it.')
        ...
        set_text('supergroup:40', '#kill supergroup: Sasha kicks every user in supergroup and removes it.')
        ...
        set_text('supergroup:45', '#mp <id>: Sasha promotes <id> to telegram\'s moderator.')
        set_text('supergroup:46', '#md <id>: Sasha demotes <id> from telegram\'s moderator.')
