...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('inrealm:18', '#kill group <group_id>: Sasha kicks all members of <group_id> and removes <group_id>.')
        set_text('inrealm:19', '#kill supergroup <group_id>: Sasha kicks all members of <group_id> and removes <group_id>.')
        set_text('inrealm:20', '#kill realm <realm_id>: Sasha kicks all members of <realm_id> and removes <realm_id>.')
        set_text('inrealm:21', '#rem <group_id>: Sasha removes group.')
        set_text('inrealm:22', '#support <user_id>|<username>: Sasha promotes specified user to support.')
        set_text('inrealm:23', '#-support <user_id>|<username>: Sasha demotes specified user from support.')
        set_text('inrealm:24', '#list admins|groups|realms: Sasha sends list of specified parameter.')
        set_text('inrealm:25', 'SUDO')
        set_text('inrealm:26', '#addadmin <user_id>|<username>: Sasha promotes specified user to administrator.')
        set_text('inrealm:27', '#removeadmin <user_id>|<username>: Sasha demotes specified user from administrator.')
