...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('pluginNotDisabled', 'This plugin is not disabled on chat.')
        ...
        -- ruleta.lua --
        set_text('alreadySigned', 'You\'re already registered, use /ruleta to die.')
        set_text('signed', ' You\'ve been registered, have a nice death.')
        ...
        set_text('cantWarnHigher', 'You cann\'t warn mod/owner/admin/sudo!')
