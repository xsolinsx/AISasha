...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text(LANG .. 'mediaNotRecognized', 'File not recognized.')
        ...
        set_text(LANG .. 'phone', '\nPhone: ')
        set_text(LANG .. 'date', '\nDate: ')
        set_text(LANG .. 'totalMessages', 'Total messages: ')
        ...
        set_text(LANG .. 'alreadyEnabled', ' already enabled.')
        set_text(LANG .. 'alreadyDisabled', ' already disabled.')
        set_text(LANG .. 'notExist', '  not exists.')
        ...
        set_text(LANG .. 'banhammer:10', '(#gban|[sasha] superbanna) <id>|<username>|<reply>: Sasha kicks and gbans specified user, if he tries to join again it\'s automatically kicked.')
        set_text(LANG .. 'banhammer:11', '(#ungban|[sasha] supersbanna) <id>|<username>|<reply>: Sasha ungbans specified user.')
        set_text(LANG .. 'banhammer:12', '(#gbanlist|[sasha] lista superban): Sasha sends gbans list.')
        ...
        set_text(LANG .. 'help:2', '#getrank|rango [<id>|<username>|<reply>]: Sasha sends rank of specified user.')
        set_text(LANG .. 'help:3', '(#help|sasha aiuto): Sasha sends a list of plugins.')
        set_text(LANG .. 'help:4', '(#help|commands|sasha aiuto) <plugin_name>|<plugin_number> [<fake_rank>]: Sasha sends help of specified plugin.')
        set_text(LANG .. 'help:5', '(#helpall|allcommands|sasha aiuto tutto) [<fake_rank>]: Sasha sends help of all plugins.')
        set_text(LANG .. 'help:6', '<fake_rank> parameter is necessary to get a help of a lower rank, ranks are: USER, MOD, OWNER, SUPPORT, ADMIN, SUDO.')

        -- info.lua --
        set_text(LANG .. 'info:0', 9)
        set_text(LANG .. 'info:1', '(#info|[sasha] info): Sasha sends user\'s info or chat\'s info or her info.')
        set_text(LANG .. 'info:2', 'MOD')
        set_text(LANG .. 'info:3', '(#info|[sasha] info) <id>|<username>|<reply>|from: Sasha sends info of specified user.')
        set_text(LANG .. 'info:4', '(#who|#members|[sasha] lista membri): Sasha users list.')
        set_text(LANG .. 'info:5', '(#kicked|[sasha] lista rimossi): Sasha sends kicked users list.')
        set_text(LANG .. 'info:6', 'OWNER')
        set_text(LANG .. 'info:7', '(#groupinfo|[sasha] info gruppo) [<group_id>]: Sasha sends info of specified group.')
        set_text(LANG .. 'info:8', 'SUDO')
        set_text(LANG .. 'info:9', '(#database|[sasha] database): Sasha saves all info of all users of group.')
        ...
        set_text(LANG .. 'ingroup:20', '(#kickinactive [<msgs>]|sasha uccidi sotto <msgs> messaggi): Sasha kicks inactive users under <msgs> messages.')
        set_text(LANG .. 'ingroup:21', 'OWNER')
        set_text(LANG .. 'ingroup:22', '(#setlink|[sasha] imposta link): Sasha saves a group\'s link with the one that will be sent.')
        set_text(LANG .. 'ingroup:23', '(#promote|[sasha] promuovi) <username>|<reply>: Sasha promotes to mod specified user.')
        set_text(LANG .. 'ingroup:24', '(#demote|[sasha] degrada) <username>|<reply>: Sasha demotes from mod specified user.')
        set_text(LANG .. 'ingroup:25', '#mute|silenzia all|text|documents|gifs|video|photo|audio: Sasha mute specified parameter.')
        set_text(LANG .. 'ingroup:26', '#unmute|ripristina all|text|documents|gifs|video|photo|audio: Sasha unmute specified parameter.')
        set_text(LANG .. 'ingroup:27', '#setowner <id>: Sasha sets <id> as owner.')
        set_text(LANG .. 'ingroup:28', '#clean modlist|rules|about: Sasha cleans specified parameter.')
        set_text(LANG .. 'ingroup:29', 'ADMIN')
        set_text(LANG .. 'ingroup:30', '#add [realm]: Sasha adds group|realm.')
        set_text(LANG .. 'ingroup:31', '#rem [realm]: Sasha removes group|realm.')
        set_text(LANG .. 'ingroup:32', '#kill chat|realm: Sasha kicks every user in group|realm and removes it.')
        set_text(LANG .. 'ingroup:33', '#setgpowner <group_id> <user_id>: Sasha sets <user_id> as owner of <group_id>.')
        ...
        set_text(LANG .. 'stats:3', '(#stats|#statslist|#messages|sasha statistiche|sasha lista statistiche|sasha messaggi): Sasha sends chat stats.')
        set_text(LANG .. 'stats:4', 'ADMIN')
        set_text(LANG .. 'stats:5', '(#stats|#statslist|#messages|sasha statistiche|sasha lista statistiche|sasha messaggi) group|gruppo <group_id>: Sasha sends <group_id> stats.')
        set_text(LANG .. 'stats:6', '(#stats|#statslist|sasha statistiche|sasha lista statistiche) aisasha: Sasha sends her stats.')

        -- strings.lua --
        set_text(LANG .. 'strings:0', 2)
        set_text(LANG .. 'strings:1', 'SUDO')
        set_text(LANG .. 'strings:2', '(#updateenstrings|#installenstrings|([sasha] installa|[sasha] aggiorna) stringhe en): Sasha updates strings.')
...
return {
    ...
    {
        "SUDO",
        "(#updateenstrings|#installenstrings|[sasha] installa|[sasha] aggiorna) stringhe en: Sasha updates strings.",
    },
    patterns =
    {
