...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('deathPercentage', 'Le probabilità di morire sono del ')
        ...
        set_text('banhammer:9', '(#kicknouser|sasha uccidi nouser|spara nouser): Sasha rimuove gli utenti senza username.')
        set_text('banhammer:10', '(#kickinactive [<msgs>]|((sasha uccidi)|spara sotto <msgs> messaggi)): Sasha rimuove tutti gli utenti inattivi sotto <msgs> messaggi.')
        set_text('banhammer:11', 'SUPPORT')
        set_text('banhammer:12', '(#gban|[sasha] superbanna) <id>|<username>|<reply>|from: Sasha superbanna l\'utente specificato e lo rimuove, se tenta di rientrare viene nuovamente rimosso.')
        set_text('banhammer:13', '(#ungban|[sasha] supersbanna) <id>|<username>|<reply>|from: Sasha supersbanna l\'utente specificato.')
        ...
        set_text('ruletagame:17', '(#kick|spara|[sasha] uccidi) random: Sasha sceglie un utente a caso e lo rimuove.')
        ...
        set_text('ruletagame:22', '#registergroup|#registragruppo: Sasha abilita il gruppo a giocare a ruleta.')
        set_text('ruletagame:23', '#deletegroup|#eliminagruppo: Sasha disabilita il gruppo per ruleta.')
        set_text('ruletagame:24', 'SUDO')
        set_text('ruletagame:25', '#createdb: Sasha crea il database di ruleta.')
