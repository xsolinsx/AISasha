...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('ruleta:2', 'Ruleta by AISasha, inspired from Leia (#RIP) and Arya (#RIP). Ruleta è la roulette russa con la pistola, tamburo da tot colpi con tot proiettili al suo interno, si spara e se c\'è il proiettile sei fuori altrimenti rimani.')
        set_text('ruleta:3', '#registerme|#registrami: Sasha registra l\'utente alla roulette.')
        set_text('ruleta:4', '#deleteme|#eliminami: Sasha elimina i dati dell\'utente.')
        set_text('ruleta:5', '#ruletainfo: Sasha manda le informazioni della roulette.')
        set_text('ruleta:6', '#mystats|#punti: Sasha manda le statistiche dell\'utente.')
        set_text('ruleta:7', '#ruleta: Sasha cerca di ucciderti.')
        set_text('ruleta:8', '#godruleta: Sasha ti dà il 50% di probabilità di guadagnare 70 punti, con l\'altro 50% li perdi tutti (richiede almeno 11 punti).')
        set_text('ruleta:9', '#challenge|#sfida <username>|<reply>: Sasha avvia una sfida tra il mittente e l\'utente specificato, il vincitore vincerà 20 punti mentre il perdente ne perderà 20.')
        set_text('ruleta:10', '#accept|#accetta: Sasha conferma la sfida.')
        set_text('ruleta:11', '#reject|#rifiuta: Sasha cancella la sfida, se la sfida è già stata avviata ed è cancellata da uno dei giocatori esso perde 20 punti e viene ucciso.')
        set_text('ruleta:12', '#challengeinfo: Sasha manda le informazioni della sfida in corso.')
        set_text('ruleta:13', '#leaderboard|#classifica [(attempts|tentativi)|(deaths|morti)|(streak|serie)|(challenges|sfide)|(victories|vittorie)|(defeats|sconfitte)]: Sasha manda la classifica del parametro specificato, se nulla è specificato manderà quella dei punteggi.')
        set_text('ruleta:14', 'MOD')
        set_text('ruleta:15', '#setcaps <value>: Sasha mette <value> proiettili nel tamburo.')
        set_text('ruleta:16', '#setchallengecaps <value>: Sasha mette <value> proiettili nel tamburo delle sfide.')
        set_text('ruleta:17', '(#kick|spara|[sasha] uccidi) random: Sasha sceglie un utente a caso e lo rimuove.')
        set_text('ruleta:18', 'OWNER')
        set_text('ruleta:19', '#setcylinder <value>: Sasha imposta un tamburo da <value> colpi nel range [5-10].')
        set_text('ruleta:20', '#setchallengecylinder <value>: Sasha imposta un tamburo da <value> colpi per le sfide nel range [5-10].')
        set_text('ruleta:21', 'ADMIN')
        set_text('ruleta:22', '#registergroup|#registragruppo: Sasha abilita il gruppo a giocare a ruleta.')
        set_text('ruleta:23', '#deletegroup|#eliminagruppo: Sasha disabilita il gruppo per ruleta.')
        set_text('ruleta:24', 'SUDO')
        set_text('ruleta:25', '#createdb: Sasha crea il database di ruleta.')
        set_text('ruleta:26', '#addpoints <id> <value>: Sasha aggiunge <value> punti all\'utente specificato.')
        set_text('ruleta:27', '#rempoints <id> <value>: Sasha sottrae <value> punti all\'utente specificato.')
