...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('botinteract:3', '#getchar: Sasha manda i caratteri necessari per l\'interazione con i bot.')
        set_text('botinteract:4', '§§<text>: Sasha manda <text> al bot.')
        set_text('botinteract:5', '#sendmedia: Sasha manderà il media che verrà inviato nella chat al bot.')
        ...
        set_text('inpm:5', '#join <chat_id>|<alias> [support]: Sasha tenta di aggiungere l\'utente a <chat_id>|<alias>.')
        ...
        set_text('ruleta:2', 'Ruleta by AISasha, inspired from Leia (#RIP) and Arya (#RIP). Ruleta è la roulette russa con la pistola, tamburo da tot colpi con tot proiettili al suo interno, si gira il tamburo e se c\'è il proiettile sei fuori altrimenti rimani.')
        ...
        set_text('ruleta:9', '#challenge|#sfida <username>|<reply>: Sasha avvia una sfida tra il mittente e l\'utente specificato.')
        set_text('ruleta:10', '#accept|#accetta: Sasha conferma la sfida.')
        set_text('ruleta:11', '#reject|#rifiuta: Sasha cancella la sfida.')
        set_text('ruleta:12', '#challengeinfo: Sasha manda le informazioni della sfida in corso.')
        set_text('ruleta:13', '#leaderboard|#classifica [(attempts|tentativi)|(deaths|morti)|(streak|serie)|(duels|challenges|duelli|sfide)|(victories|vittorie)|(defeats|sconfitte)]: Sasha manda la classifica del parametro specificato, se nulla è specificato manderà quella dei punteggi.')
