...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text(LANG .. 'notExists', ' non esiste.')
        ...
        set_text(LANG .. 'neverWarn', 'Gli avvertimenti non funzioneranno più.')
        ...
        set_text(LANG .. 'neverWelcome', 'Il messaggio di benvenuto non sarà più mandato.')
        ...
        set_text(LANG .. 'banhammer:9', '(#kickinactive [<msgs>]|((sasha uccidi)|spara sotto <msgs> messaggi)): Sasha rimuove tutti gli utenti inattivi sotto <msgs> messaggi.')
        set_text(LANG .. 'banhammer:10', 'SUPPORT')
        set_text(LANG .. 'banhammer:11', '(#gban|[sasha] superbanna) <id>|<username>|<reply>: Sasha superbanna l\'utente specificato e lo rimuove, se tenta di rientrare viene nuovamente rimosso.')
        set_text(LANG .. 'banhammer:12', '(#ungban|[sasha] supersbanna) <id>|<username>|<reply>: Sasha supersbanna l\'utente specificato.')
        set_text(LANG .. 'banhammer:13', '(#gbanlist|[sasha] lista superban): Sasha mostra la lista di utenti super bannati.')
        ...
        set_text(LANG .. 'duckduckgo:1', '#duck[duck]go <terms>: Sasha cerca <terms> su DuckDuckGo.')
        ...
        set_text(LANG .. 'help:2', '(#help|sasha aiuto): Sasha mostra una lista dei plugin disponibili.')
        set_text(LANG .. 'help:3', '(#help|commands|sasha aiuto) <plugin_name>|<plugin_number> [<fake_rank>]: Sasha mostra l\'aiuto per il plugin specificato.')
        set_text(LANG .. 'help:4', '(#helpall|allcommands|sasha aiuto tutto) [<fake_rank>]: Sasha mostra tutti i comandi di tutti i plugin.')
        set_text(LANG .. 'help:5', 'Il parametro <fake_rank> serve per mandare l\'help di un rango più basso, i ranghi sono: USER, MOD, OWNER, SUPPORT, ADMIN, SUDO.')

        -- info.lua --
        set_text(LANG .. 'info:0', 10)
        set_text(LANG .. 'info:1', '#getrank|rango [<id>|<username>|<reply>]: Sasha manda il rank dell\'utente.')
        set_text(LANG .. 'info:2', '(#info|[sasha] info): Sasha manda le info dell\'utente e della chat o di se stessa')
        set_text(LANG .. 'info:3', 'MOD')
        set_text(LANG .. 'info:4', '(#info|[sasha] info) <id>|<username>|<reply>|from: Sasha manda le info dell\'utente specificato.')
        set_text(LANG .. 'info:5', '(#who|#members|[sasha] lista membri): Sasha manda la lista degli utenti.')
        set_text(LANG .. 'info:6', '(#kicked|[sasha] lista rimossi): Sasha manda la lista degli utenti rimossi.')
        set_text(LANG .. 'info:7', 'OWNER')
        set_text(LANG .. 'info:8', '(#groupinfo|[sasha] info gruppo) [<group_id>]: Sasha manda le info del gruppo specificato.')
        set_text(LANG .. 'info:9', 'SUDO')
        set_text(LANG .. 'info:10', '(#database|[sasha] database): Sasha salva i dati di tutti gli utenti.')
        ...
        set_text(LANG .. 'ingroup:21', '(#setlink|[sasha] imposta link): Sasha imposta il link d\'invito con quello che le verrà inviato.')
        set_text(LANG .. 'ingroup:22', '(#promote|[sasha] promuovi) <username>|<reply>: Sasha promuove a moderatore l\'utente specificato.')
        set_text(LANG .. 'ingroup:23', '(#demote|[sasha] degrada) <username>|<reply>: Sasha degrada l\'utente specificato.')
        set_text(LANG .. 'ingroup:24', '#mute|silenzia all|text|documents|gifs|video|photo|audio: Sasha imposta il muto sulla variabile specificata.')
        set_text(LANG .. 'ingroup:25', '#unmute|ripristina all|text|documents|gifs|video|photo|audio: Sasha rimuove il muto sulla variabile specificata.')
        set_text(LANG .. 'ingroup:26', '#setowner <id>: Sasha imposta <id> come proprietario.')
        set_text(LANG .. 'ingroup:27', '#clean modlist|rules|about: Sasha pulisce il parametro specificato.')
        set_text(LANG .. 'ingroup:28', 'ADMIN')
        set_text(LANG .. 'ingroup:29', '#add [realm]: Sasha aggiunge il gruppo|regno.')
        set_text(LANG .. 'ingroup:30', '#rem [realm]: Sasha rimuove il gruppo|regno.')
        set_text(LANG .. 'ingroup:31', '#kill chat|realm: Sasha elimina ogni utente nel gruppo|regno e poi lo chiude.')
        set_text(LANG .. 'ingroup:32', '#setgpowner <group_id> <user_id>: Sasha imposta <user_id> come proprietario.')
        ...
        set_text(LANG .. 'stats:3', '(#stats|#messages): Sasha invia le statistiche della chat.')
        set_text(LANG .. 'stats:4', '(#statslist|#messageslist): Sasha invia un file con le statistiche della chat.')
        set_text(LANG .. 'stats:5', 'ADMIN')
        set_text(LANG .. 'stats:6', '(#stats|#messages) group <group_id>: Sasha invia le statistiche relative al gruppo specificato.')
        set_text(LANG .. 'stats:7', '(#statslist|#messageslist) group <group_id>: Sasha invia un file con le statistiche relative al gruppo specificato.')
        set_text(LANG .. 'stats:8', '(#stats|#messages) aisasha: Sasha invia le proprie statistiche.')
        ...
        set_text(LANG .. 'warn:2', '#setwarn <value>: Sasha imposta gli avvertimenti massimi a <value>, se zero gli avvertimenti non funzioneranno più.')
        ...
        set_text(LANG .. 'welcome:4', '#setmemberswelcome <value>: Sasha dopo <value> membri manderà il benvenuto con le regole, se zero il benvenuto non verrà più mandato.')
