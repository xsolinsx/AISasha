...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('banhammer:4', '(#kick|spara|[sasha] uccidi) <id>|<username>|<reply>: Sasha rimuove l\'utente specificato.')
        set_text('banhammer:5', '(#ban|esplodi|kaboom|[sasha] banna|[sasha] decompila) <id>|<username>|<reply>: Sasha banna l\'utente specificato e lo rimuove, se tenta di rientrare viene nuovamente rimosso.')
        set_text('banhammer:6', '(#unban|[sasha] sbanna|[sasha] [ri]compila) <id>|<username>|<reply>: Sasha sbanna l\'utente specificato.')
        ...
        set_text('banhammer:12', '(#gban|[sasha] superbanna) <id>|<username>|<reply>: Sasha superbanna l\'utente specificato e lo rimuove, se tenta di rientrare viene nuovamente rimosso.')
        set_text('banhammer:13', '(#ungban|[sasha] supersbanna) <id>|<username>|<reply>: Sasha supersbanna l\'utente specificato.')
        ...
        set_text('supergroup:20', '#muteuser|voce <id>|<username>|<reply>: Sasha imposta|toglie il muto sull\'utente.')
