...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('inrealm:18', '#kill group <group_id>: Sasha rimuove tutti i membri di <group_id> e <group_id>.')
        set_text('inrealm:19', '#kill supergroup <group_id>: Sasha rimuove tutti i membri di <group_id> e <group_id>.')
        set_text('inrealm:20', '#kill realm <realm_id>: Sasha rimuove tutti i membri di <realm_id> e <realm_id>.')
