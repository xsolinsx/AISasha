...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('info:4', 'MOD')
        set_text('info:5', '(#info|[sasha] info) <id>|<username>|<reply>|from: Sasha manda le info dell\'utente specificato.')
        set_text('info:6', '(#who|#members|[sasha] lista membri): Sasha manda la lista degli utenti.')
        set_text('info:7', '(#kicked|[sasha] lista rimossi): Sasha manda la lista degli utenti rimossi.')
        set_text('info:8', 'OWNER')
        set_text('info:9', '(#groupinfo|[sasha] info gruppo) [<group_id>]: Sasha manda le info del gruppo specificato.')
        set_text('info:10', 'SUDO')
        set_text('info:11', '(#database|[sasha] database): Sasha salva i dati di tutti gli utenti.')
