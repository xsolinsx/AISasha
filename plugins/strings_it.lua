...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('ingroup:21', '(#setlink|[sasha] imposta link) <link>: Sasha imposta <link> come link d\'invito.')
        ...
        set_text('ingroup:31', '#kill group|realm: Sasha elimina ogni utente nel gruppo|regno e poi lo chiude.')
        ...
        set_text('inrealm:18', '#kill group|supergroup|realm <group_id>: Sasha rimuove tutti i membri di <group_id> e <group_id>.')
        set_text('inrealm:21', '#rem <group_id>: Sasha rimuove il gruppo.')
        set_text('inrealm:22', '#support <user_id>|<username>: Sasha promuove l\'utente specificato a supporto.')
        set_text('inrealm:23', '#-support <user_id>|<username>: Sasha degrada l\'utente specificato.')
        set_text('inrealm:24', '#list admins|groups|realms: Sasha mostra una lista della variabile specificata.')
        set_text('inrealm:25', 'SUDO')
        set_text('inrealm:26', '#addadmin <user_id>|<username>: Sasha promuove l\'utente specificato ad amminstratore.')
        set_text('inrealm:27', '#removeadmin <user_id>|<username>: Sasha degrada l\'utente specificato.')
        ...
        set_text('ruleta:1', 'Ruleta by AISasha, inspired from Leia (#RIP) and Arya (#RIP). Ruleta è la roulette russa con la pistola, tamburo da tot colpi con tot proiettili al suo interno, si gira il tamburo e se c\'è il proiettile sei fuori altrimenti rimani.')
        ...
        set_text('stats:4', '(#realstats|#realmessages): Sasha invia le statistiche con solo i membri del gruppo.')
        set_text('stats:5', '(#cleanstats|#cleanmessages): Sasha pulisce le statistiche.')
        set_text('stats:6', '(#statslist|#messageslist): Sasha invia un file con le statistiche della chat.')
        set_text('stats:7', 'ADMIN')
        set_text('stats:8', '(#stats|#messages) group <group_id>: Sasha invia le statistiche relative al gruppo specificato.')
        set_text('stats:9', '(#realstats|#realmessages) group <group_id>: Sasha invia le statistiche relative al gruppo specificato con solo i membri del gruppo.')
        set_text('stats:10', '(#cleanstats|#cleanmessages) group <group_id>: Sasha pulisce le statistiche relative al gruppo specificato.')
        set_text('stats:11', '(#statslist|#messageslist) group <group_id>: Sasha invia un file con le statistiche relative al gruppo specificato.')
        set_text('stats:12', '(#stats|#messages) aisasha: Sasha invia le proprie statistiche.')
        ...
        set_text('supergroup:25', '(#setlink|sasha imposta link) <link>: Sasha imposta <link> come link d\'invito.')
        ...
        set_text('supergroup:40', '#kill supergroup: Sasha elimina ogni utente nel supergruppo e poi lo chiude.')
        set_text('supergroup:41', 'peer_id')
        set_text('supergroup:42', 'msg.to.id')
        set_text('supergroup:43', 'msg.to.peer_id')
        set_text('supergroup:44', 'SUDO')
        set_text('supergroup:45', '#mp <id>: Sasha promuove <id> a moderatore del gruppo (telegram).')
        set_text('supergroup:46', '#md <id>: Sasha degrada <id> dal ruolo di moderatore del gruppo (telegram).')
