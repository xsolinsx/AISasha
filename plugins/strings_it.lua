...
local function run(msg, matches)
    if is_sudo(msg) then
        ...
        set_text('ruleta:14', '#setcaps <value>: Sasha mette <value> proiettili nel tamburo.')
        set_text('ruleta:15', '#setchallengecaps <value>: Sasha mette <value> proiettili nel tamburo delle sfide.')
        set_text('ruleta:16', '(#kick|spara|[sasha] uccidi) random: Sasha sceglie un utente a caso e lo rimuove.')
        set_text('ruleta:17', 'OWNER')
        set_text('ruleta:18', '#setcylinder <value>: Sasha imposta un tamburo da <value> colpi nel range [5-10].')
        set_text('ruleta:19', '#setchallengecylinder <value>: Sasha imposta un tamburo da <value> colpi per le sfide nel range [5-10].')
        set_text('ruleta:20', 'ADMIN')
        set_text('ruleta:21', '#registergroup|#registragruppo: Sasha abilita il gruppo a giocare a ruleta.')
        set_text('ruleta:22', '#deletegroup|#eliminagruppo: Sasha disabilita il gruppo per ruleta.')
        set_text('ruleta:23', 'SUDO')
        set_text('ruleta:24', '#createdb: Sasha crea il database di ruleta.')
        set_text('ruleta:25', '#addpoints <id> <value>: Sasha aggiunge <value> punti all\'utente specificato.')
        set_text('ruleta:26', '#rempoints <id> <value>: Sasha sottrae <value> punti all\'utente specificato.')
        ...
        set_text('supergroup:18', '#setflood <value>: Sasha imposta il flood massimo a <value> che deve essere compreso tra 5 e 20.')
