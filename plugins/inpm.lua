local function chat_list(msg)
    ...
    local message = langs.groupsJoin
...
local function run(msg, matches)
    ...
    if msg.service and user_type == "support" and msg.action.type == "chat_add_user" and msg.from.id == 0 then
        ...
        if username then
            -- send_large_msg("user#id" .. user_id, langs.supportAdded .. "@" .. username .. " " .. user_id .. langs.toChat') .. group_name .. " ID:" .. msg.to.id)
        else
            -- send_large_msg("user#id" .. user_id, langs.supportAdded .. user_id .. langs.toChat') .. group_name .. " ID:" .. msg.to.id)
        end
    end
    if msg.service and user_type == "admin" and msg.action.type == "chat_add_user" and msg.from.id == 0 then
        ...
        if username then
            -- send_large_msg("user#id" .. user_id, langs.adminAdded .. "@" .. username .. " " .. user_id .. langs.toChat') .. group_name .. " ID:" .. msg.to.id)
        else
            -- send_large_msg("user#id" .. user_id, langs.adminAdded .. user_id .. langs.toChat') .. group_name .. " ID:" .. msg.to.id)
        end
    end
    ...
    if msg.service and user_type == "regular" and msg.action.type == "chat_add_user" and msg.from.id == 0 then
        ...
        -- send_large_msg("user#id" .. user_id, langs.addedTo .. group_name .. " ID:" .. msg.to.id)
    end
