...
return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha blocca l\'opzione specificata.',
            '(#unlock|[sasha] sblocca) arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha sblocca l\'opzione specificata.',
            'SUPERGRUPPI',
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha locks specified parameter.',
            '(#unlock|[sasha] sblocca) arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha unlocks specified parameter.',
            'SUPERGROUPS',
