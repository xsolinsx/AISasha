...
return {
    ...
    it =
    {
        ...
        autocrossexecDenial = "Non puoi usarlo tramite un altro comando.",
        ...
        score = "Punteggio: ",
        scoreAttemptsRatio = "Rapporto punti/tentativi: ",
        ...
        banhammer =
        {
            ...
            "(#kick|spara|[sasha] uccidi) <id>|<username>|<reply>|from: Sasha banna(telegram) l'utente specificato.",
            "(#ban|esplodi|kaboom|[sasha] banna|[sasha] decompila) <id>|<username>|<reply>|from: Sasha banna l'utente specificato.",
            ...
            "#kickrandom: Sasha sceglie un utente a caso e lo banna(telegram).",
            "#kickdeleted: Sasha banna(telegram) tutti gli account eliminati.",
            "OWNER",
            "#kicknouser: Sasha banna(telegram) tutti gli utenti senza username.",
            "#kickinactive [<msgs>]: Sasha banna(telegram) tutti gli utenti inattivi sotto <msgs> messaggi, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
            "ADMIN",
            "(#banlist|[sasha] lista ban) <group_id>: Sasha mostra la lista di utenti bannati da <group_id>.",
            "(#gban|[sasha] superbanna) <id>|<username>|<reply>|from: Sasha superbanna l'utente specificato e lo banna(telegram).",
        ...
        database =
        {
            ...
            "#countdatabase: Sasha manda il numero di oggetti nel suo database.",
        ...
        group_management =
        {
            ...
            "(#link|sasha link): Sasha mostra il link del gruppo, se permesso dai moderatori.",
            ...
            "(#[un]lock|[sasha] [s]blocca) <setting_type>: Sasha [s]blocca <setting_type>.",
            ...
            "#allchats[list]: Sasha mostra l'elenco delle chat, se \"list\" come un file.",
            ...
            "(#[un]lock|[sasha] [s]blocca) <group_id> <setting_type>: Sasha [s]blocca <setting_type> in <group_id>.",
            "<setting_type> può essere: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
        ...
        ruletagame =
        {
            ...
            "#challenge|#sfida [<username>|<reply>]: Sasha avvia una sfida tra il mittente e l'utente specificato, se nessun utente è specificato chiunque può accettare la sfida, il vincitore vincerà 20 punti mentre il perdente ne perderà 20.",
        ...
        stats =
        {
            ...
            "MOD",
            "(#stats|#messages): Sasha invia le statistiche della chat, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
            "(#realstats|#realmessages): Sasha invia le statistiche con solo i membri del gruppo, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
            "(#cleanstats|#cleanmessages): Sasha pulisce le statistiche.",
            "(#statslist|#messageslist): Sasha invia un file con le statistiche della chat, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
            "ADMIN",
            "(#stats|#messages) group <group_id>: Sasha invia le statistiche relative al gruppo specificato, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
            "(#realstats|#realmessages) group <group_id>: Sasha invia le statistiche relative al gruppo specificato con solo i membri del gruppo, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
            "(#cleanstats|#cleanmessages) group <group_id>: Sasha pulisce le statistiche relative al gruppo specificato.",
            "(#statslist|#messageslist) group <group_id>: Sasha invia un file con le statistiche relative al gruppo specificato, se c'è l'api_patch vengono usati i contatori di @AISashaBot.",
        ...
        webshot =
        {
            ...
            "MOD",
            "(#webshot|[sasha] webshotta) <url> [<width>x<height>|full]: Sasha esegue uno screenshot di <url> e lo invia.",
        },
    ...
    en =
    {
        ...
        autocrossexecDenial = "You can't use it from another command.",
        ...
        score = "Score: ",
        scoreAttemptsRatio = "Score/attempts ratio: ",
        cheating = "Cheat used.",
        ...
        banhammer =
        {
            ...
            "(#warn|[sasha] avverti) <id>|<username>|<reply>|from: Sasha warns the specified user.",
            "#unwarn <id>|<username>|<reply>|from: Sasha removes one warn from the specified user.",
            "(#unwarnall|[sasha] azzera avvertimenti) <id>|<username>|<reply>|from: Sasha removes all warns from the specified user.",
            "(#kick|spara|[sasha] uccidi) <id>|<username>|<reply>|from: Sasha bans(telegram) the specified user.",
            "(#ban|esplodi|kaboom|[sasha] banna|[sasha] decompila) <id>|<username>|<reply>|from: Sasha bans the specified user.",
            "(#unban|[sasha] sbanna|[sasha] [ri]compila) <id>|<username>|<reply>|from: Sasha unbans the specified user.",
            "(#banlist|[sasha] lista ban): Sasha sends bans list of the group.",
            "#kickrandom: Sasha chooses a random user and bans(telegram) it.",
            "#kickdeleted: Sasha bans(telegram) all deleted accounts.",
            "OWNER",
            "#kicknouser: Sasha bans(telegram) users without username.",
            "#kickinactive [<msgs>]: Sasha bans(telegram) inactive users under <msgs> messages, if there's the api_patch the counters used are from @AISashaBot.",
            "ADMIN",
            "(#banlist|[sasha] lista ban) <group_id>: Sasha sends bans list of <group_id>.",
            "(#gban|[sasha] superbanna) <id>|<username>|<reply>|from: Sasha gbans the specified user.",
        ...
        bot =
        {
            ...
            "ADMIN",
            "#bot|sasha on|off [<group_id>]: Sasha goes on|off on the specified group.",
        },
        ...
        database =
        {
            ...
            "#countdatabase: Sasha sends the number of objects in her database.",
        ...
        group_management =
        {
            ...
            "(#link|sasha link): Sasha sends group's link, if allowed by mods.",
            ...
            "(#[un]lock|[sasha] [s]blocca) <setting_type>: Sasha [un]locks <setting_type>.",
            ...
            "#del <reply>: Sasha deletes the specified message.",
            "OWNER",
            ...
            "(#promote|[sasha] promuovi) <username>|<reply>: Sasha promotes to mod the specified user.",
            "(#demote|[sasha] degrada) <username>|<reply>: Sasha demotes from mod the specified user.",
            ...
            "#setowner <id>|<username>|<reply>: Sasha sets the specified user as owner.",
            "GROUPS",
            "#clean modlist|rules|about: Sasha cleans the specified parameter.",
            "SUPERGROUPS",
            ...
            "#promoteadmin <id>|<username>|<reply>: Sasha promotes the specified user to telegram's administrator.",
            "#demoteadmin <id>|<username>|<reply>: Sasha demotes the specified user from telegram's administrator.",
            "#clean rules|about|modlist|mutelist: Sasha cleans the specified parameter.",
            "ADMIN",
            "#add [realm]: Sasha adds the group in which you are, if \"realm\" as realm.",
            "#rem [realm]: Sasha removes the group in which you are, if \"realm\" as realm.",
            "ex INGROUP.LUA",
            ...
            "#allchats[list]: Sasha sends a list of all chats, if \"list\" as a file.",
            ...
            "(#creategroup|sasha crea gruppo) <group_name>: Sasha creates a group with the specified name.",
            "(#createsuper|sasha crea supergruppo) <group_name>: Sasha creates a supergroup with the specified name.",
            "(#createrealm|sasha crea regno) <realm_name>: Sasha creates a realm with the specified name.",
            ...
            "(#[un]lock|[sasha] [s]blocca) <group_id> <setting_type>: Sasha [un]locks <group_id>'s <setting_type>.",
            "<setting_type> can be: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
        ...
        help =
        {
            ...
            "(#help|sasha aiuto) <plugin_name>|<plugin_number>: Sasha sends help of the specified plugin.",
        ...
        info =
        {
            ...
            "#getrank|rango [<id>|<username>|<reply>|from]: Sasha sends rank of the specified user.",
            ...
            "MOD",
            "(#info|[sasha] info) <id>|<username>|<reply>|from: Sasha sends info of the specified user.",
        ...
        ruletagame =
        {
            ...
            "#challenge|#sfida <username>|<reply>: Sasha starts a challenge between sender and the specified user, if the user is not the specified everyone can accept the challenge, the winner will win 20 points while the loser will lose 20 points.",
            ...
            "#leaderboard|#classifica [(attempts|tentativi)|(deaths|morti)|(streak|serie)|(challenges|sfide)|(victories|vittorie)|(defeats|sconfitte)]: Sasha sends the leaderboard of the specified parameter, if nothing is the specified the leaederboard will show scores.",
            "MOD",
            ...
            "#addpoints <id> <value>: Sasha adds <value> points to the specified user.",
        ...
        spam =
        {
            ...
            "Plugin for spamming.",
            "OWNER",
            "(#spam|[sasha] spamma) [<messages> <seconds>] <reply>|<text>: Sasha starts spamming <reply>|<text> if the specified for <messages> times every <seconds> seconds, otherwise 5 messages one every 2 seconds.",
        },
        ...
        stats =
        {
            ...
            "MOD",
            "(#stats|#messages): Sasha sends chat's stats, if there's the api_patch the counters used are from @AISashaBot.",
            "(#realstats|#realmessages): Sasha sends chat's stats with just group members, if there's the api_patch the counters used are from @AISashaBot.",
            "(#cleanstats|#cleanmessages): Sasha cleans chat's stats.",
            "(#statslist|#messageslist): Sasha sends file with chat's stats, if there's the api_patch the counters used are from @AISashaBot.",
            "ADMIN",
            "(#stats|#messages) group <group_id>: Sasha sends <group_id>'s stats, if there's the api_patch the counters used are from @AISashaBot.",
            "(#realstats|#realmessages) group <group_id>: Sasha sends <group_id>'s stats with just group members, if there's the api_patch the counters used are from @AISashaBot.",
            "(#cleanstats|#cleanmessages) group <group_id>: Sasha cleans <group_id>'s stats.",
            "(#statslist|#messageslist) group <group_id>: Sasha sends file with <group_id>'s stats, if there's the api_patch the counters used are from @AISashaBot.",
        ...
        webshot =
        {
            ...
            "MOD",
            "(#webshot|[sasha] webshotta) <url> [<width>x<height>|full]: Sasha does a screenshot of <url> and sends it.",
        },
