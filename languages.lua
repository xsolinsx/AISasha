...
return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha blocca l\'impostazione specificata di <group_id>.',
            '(#unlock|[sasha] sblocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha sblocca l\'impostazione specificata di <group_id>.',
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha locks <group_id>\'s specified setting.',
            '(#unlock|[sasha] sblocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|name|photo|public|rtl|spam|strict: Sasha unlocks <group_id>\'s specified setting.',
