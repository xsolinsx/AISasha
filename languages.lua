...
return {
    ...
    it =
    {
        ...
        banhammer =
        {
            ...
            '#kickinactive [<msgs>]: Sasha banna(telegram) tutti gli utenti inattivi sotto <msgs> messaggi.',
            'ADMIN',
    ...
    en =
    {
        ...
        banhammer =
        {
            ...
            '#kickinactive [<msgs>]: Sasha bans(telegram) inactive users under <msgs> messages.',
            'ADMIN',
