return {
    it =
    {
        ...
        errorCreateSuperLink = 'Errore creazione link d\'invito.\nNon sono la creatrice.\n\nSe hai il link usa /setlink per impostarlo',
        ...
        youGbanned = 'Sei bannato globalmente.',
        youBanned = 'Sei bannato.',
        chatNotFound = 'Chat non trovata.',
        privateGroup = 'Gruppo privato.',
        addedTo = 'Sei stato aggiunto a: ',
        supportAdded = 'Aggiunto membro di supporto ',
        adminAdded = 'Aggiunto admin ',
        toChat = ' a 👥 ',
        ...
        inpm =
        {
            ...
            'ADMIN',
            '(#join|#inviteme|[sasha] invitami) <chat_id>|<alias> [support]: Sasha tenta di aggiungere l\'utente a <chat_id>|<alias>.',
    ...
    en =
    {
        ...
        youGbanned = 'You are globally banned.',
        youBanned = 'You are banned.',
        chatNotFound = 'Chat not found.',
        privateGroup = 'Private group.',
        addedTo = 'You\'ve been added to: ',
        ...
        inpm =
        {
            ...
            'ADMIN',
            '(#join|#inviteme|[sasha] invitami) <chat_id>|<alias> [support]: Sasha tries to add the sender to <chat_id>|<alias>.',
        ...
        supergroup =
        {
            ...
            '(#setlink|sasha imposta link) <link>: Sasha saves <link> as group\'s link.',
            '#setadmin <id>|<username>|<reply>: Sasha promotes specified user to telegram\'s administrator.',
