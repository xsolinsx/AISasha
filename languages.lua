...
return {
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) arabic|bots|flood|grouplink|leave|link|member|name|photo|rtl|spam|strict: Sasha locks the specified setting.',
            '(#unlock|[sasha] sblocca) arabic|bots|flood|grouplink|leave|link|member|name|photo|rtl|spam|strict: Sasha unlocks the specified setting.',
            'SUPERGROUPS',
            ...
            '#mute|silenzia all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video_note|voice_note: Sasha mute the specified parameter.',
            '#unmute|ripristina all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video_note|voice_note: Sasha unmute the specified parameter.',
            ...
            '(#lock|[sasha] blocca) <group_id> arabic|bots|flood|grouplink|leave|link|member|name|photo|rtl|spam|strict: Sasha locks <group_id>\'s the specified setting.',
            '(#unlock|[sasha] sblocca) <group_id> arabic|bots|flood|grouplink|leave|link|member|name|photo|rtl|spam|strict: Sasha unlocks <group_id>\'s the specified setting.',
