...
return {
    ...
    en =
    {
        ...
        ruletagame =
        {
            ...
            '#challenge|#sfida <username>|<reply>: Sasha starts a challenge between sender and specified user, if the user is not specified everyone can accept the challenge, the winner will win 20 points while the loser will lose 20 points.',
